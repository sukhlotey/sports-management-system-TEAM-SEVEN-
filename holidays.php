							...
							<div class="box-header">
								...
								<?php if ( $_SESSION['Login_Type'] == 'admin' ) { ?>
									<button type="button" class="btn btn-xs btn-primary pull-right" data-toggle="modal" data-target="#HolidayModal">
										<i class="fa fa-plus"></i> Add STATS
									</button>
								<?php } ?>
							</div>
							<div class="box-body">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title">STATICS</h4>
						</div>
						<form method="post" role="form" data-toggle="validator" id="holiday-form">
							<div class="modal-body">
								<div class="form-group">
									<label for="holiday_title">TEAMS</label>
									<input type="text" class="form-control" id="holiday_title" name="holiday_title" placeholder="TEAMS" required />
								</div>
								<div class="form-group">
									<label for="holiday_desc">VENUE</label>
									<textarea class="form-control" id="holiday_desc" name="holiday_desc" placeholder="VENUE" required></textarea>
								</div>
								<div class="form-group">
					                <label for="holiday_date">MATCH Date (MM/DD/YYYY)</label>
					            	...
					            	<div class="col-sm-6">
							            <div class="form-group">
											<label for="compulsory_holiday">
												<input type="radio" value="compulsory" id="compulsory_holiday" name="holiday_type" class="minimal" checked /> WIN
											</label>
										</div>
									</div>
									<div class="col-sm-6">
							            <div class="form-group">
											<label for="restricted_holiday">
												<input type="radio" value="restricted" id="restricted_holiday" name="holiday_type" class="minimal" /> LOSS
											</label>
										</div>
									</div>
					            </div>
							...
							<div class="modal-footer">
								...
								<button type="submit" name="submit" class="btn btn-primary">Save Stats</button>
							</div>
						</form>
					</div>
				</div>
